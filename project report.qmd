...
```{r}
# Summary statistics of the dataset :We first examine the summary statistics of the dataset to understand the overall distribution of the variables, including their mean, median, and range. This helps identify potential issues such as skewness or extreme values that may impact the analysis.
summary(data)
```
...
kable(vif_values, caption = "VIF for Predictors")
```
...
>>>>>>> 0d1262ea546b3b660036caa0dfe9b4bdd1a318c4
